...
##
    ...
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_orig, out_fname=f'{dstdir}/pval_7d_28d_uncorrected', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_fdr, out_fname=f'{dstdir}/pval_7d_28d_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_orig, out_fname=f'{dstdir}/pval_7d_28d_uncorrected_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval2_fdr, out_fname=f'{dstdir}/pval2_7d_28d', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval2_orig, out_fname=f'{dstdir}/pval2_7d_28d_uncorrected', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval2_fdr, out_fname=f'{dstdir}/pval2_7d_28d_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval2_orig, out_fname=f'{dstdir}/pval2_7d_28d_uncorrected_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_opp_fdr, out_fname=f'{dstdir}/pval_opp_7d_28d', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_opp_orig, out_fname=f'{dstdir}/pval_opp_7d_28d_uncorrected', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_opp_fdr, out_fname=f'{dstdir}/pval_opp_7d_28d_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_opp_orig, out_fname=f'{dstdir}/pval_opp_7d_28d_uncorrected_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
...
##
    ...
    plot_atlas_var(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                   var_7d_shm, out_fname=f'{dstdir}/var_7d_shm',
...
##
    ...
    plot_atlas_var(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                   var_28d_shm, out_fname=f'{dstdir}/var_28d_shm',
                   vmax=args.vmax, cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)#, vmax=0.0006, vmin=0.0004)
...
##
    ...
    plot_atlas_var(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                   var_7d_inj, out_fname=f'{dstdir}/var_7d_inj',
                   vmax=args.vmax, cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)#, vmax=0.0006, vmin=0.0004)
    ...
    plot_atlas_var(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                   var_28d_inj, out_fname=f'{dstdir}/var_28d_inj',
                   vmax=args.vmax, cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)#, vmax=0.0006, vmin=0.0004)
    ...
    plot_atlas_var(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                   var_28d_shm, out_fname=f'{dstdir}/var_28d_shm_7d_shm',
                   vmax=args.vmax, cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)#, vmax=0.0006, vmin=0.0004)
    ...
    plot_atlas_var(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                   var_7d_inj, out_fname=f'{dstdir}/var_7d_inj_7d_shm',
                   vmax=args.vmax, cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)#, vmax=0.0006, vmin=0.0004)
    ...
    plot_atlas_var(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                   var_28d_inj, out_fname=f'{dstdir}/var_28d_inj_7d_shm',
                   vmax=args.vmax, cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)#, vmax=0.0006, vmin=0.0004)
...
# Which ROIs get worse in TBI: 7d inj vs 28d injury
    ...
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    ...
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_orig, out_fname=f'{dstdir}/rois_affected_uncorrected', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_fdr, out_fname=f'{dstdir}/rois_affected_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval_orig, out_fname=f'{dstdir}/rois_affected_uncorrected_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval2_fdr, out_fname=f'{dstdir}/rois_get_better', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval2_orig, out_fname=f'{dstdir}/rois_get_better_uncorrected', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval2_fdr, out_fname=f'{dstdir}/rois_get_better_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval2_orig, out_fname=f'{dstdir}/rois_get_better_uncorrected_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval3_fdr, out_fname=f'{dstdir}/rois_get_worse', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval3_orig, out_fname=f'{dstdir}/rois_get_worse_uncorrected', alpha=0.05,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval3_fdr, out_fname=f'{dstdir}/rois_get_worse_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
    plot_atlas_pval(atlas_image, atlas_labels, np.arange(1, num_rois+1),
                    pval3_orig, out_fname=f'{dstdir}/rois_get_worse_uncorrected_unthresholded', alpha=1.0,
                    cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar)
