...
if __name__ == "__main__":
    ...
    #plot_atlas_var(
    #    atlas_fname, np.arange(1, num_rois + 1), var_7d_inj, out_fname=f"{dstdir}/var_7d_inj_nonparametric"
    #)
    plot_atlas_var(
        atlas_image,
        atlas_labels,
    ...
    #plot_atlas_var(
    #    atlas_fname, np.arange(1, num_rois + 1), var_28d_inj, out_fname=f"{dstdir}/var_28d_inj_nonparametric"
    #)
    ...
    plot_atlas_pval(
        ...
        np.arange(1, num_rois + 1),
        pval_orig,
        out_fname=f"{dstdir}/rois_affected_nonparametric_uncorrected_alpha015",
        alpha=0.15,
        cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar
    )
    plot_atlas_pval(
    ...
    plot_atlas_pval(
        ...
        np.arange(1, num_rois + 1),
        pval2_orig,
        out_fname=f"{dstdir}/rois_get_better_nonparametric_uncorrected_alpha015",
        alpha=0.15,
        cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar
    )
    plot_atlas_pval(
    ...
    plot_atlas_pval(
        ...
        np.arange(1, num_rois + 1),
        pval3_orig,
        out_fname=f"{dstdir}/rois_get_worse_nonparametric_uncorrected_alpha015",
        alpha=0.15,
        cmap=args.cmap,annotate=args.annotate,colorbar=args.colorbar
    )
    plot_atlas_pval(
    ...
    with open(f'{dstdir}/rois_affected_rois_get_better_rois_get_worse_pvalues_degree_nonparametric.csv', 'w', encoding='utf-8', newline='') as outcsv:
