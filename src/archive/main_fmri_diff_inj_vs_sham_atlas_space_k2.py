...
def plot_atlas_pval(atlas_fname, roi_ids, pval, out_fname, alpha=0.05):
    ...
    plotting.plot_stat_map(bg_img=atlas, stat_map_img=pval_vol, vmax=alpha, threshold=0.0, output_file=out_fname + '_w_k2.png',
...
def plot_atlas_var(atlas_fname, roi_ids, roi_var, out_fname):
    ...
    # plot var
    plotting.plot_stat_map(bg_img=atlas, stat_map_img=val_vol, threshold=0.0, output_file=out_fname + '_w_k2.png', draw_cross=False,
